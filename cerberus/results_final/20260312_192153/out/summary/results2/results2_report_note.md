...
Across this required production window, Velocity-Verlet remains near the target state and shows small bounded energy drift. Forward Euler shows strong energy drift and heats to 396.05 K over the same window, so it is not suitable for a stable NVE Argon trajectory here.
